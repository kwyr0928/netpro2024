...
public class FacesAWTKawaseYuri {
    ...
    private class FaceObj {
        ...
        public void drawRim(Graphics g) {
            ...
            g.fillRoundRect(xStart + 5, yStart + 5, 200, 200, 200, 200);
        ...
        public void drawhoo(Graphics g) {
            g.setColor(Color.pink);
            switch (emotion) {
                case "Happy":
                    g.fillOval(xStart + 20, yStart + 100, 30, 30);
                    g.fillOval(xStart + 150, yStart + 100, 30, 30);
                    break;
                case "Sad":
                    g.fillOval(xStart + 20, yStart + 100, 30, 30);
                    g.fillOval(xStart + 150, yStart + 100, 30, 30);
